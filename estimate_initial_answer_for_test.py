...
def main():
    ...
    dataloader = datasetLoader(args.dataset, split='test')
    ...
    for i, line in enumerate(lines):
        ...
        x, y, response = data['question'], dataloader[i][-1], data['initial_response']
        ...
        with open(f"./logs/{args.dataset}_{model_name}_test_initial_response.jsonl", "a+") as f:
            inst = {
                'idx': i,
                'question': question,
